...
def main(_Title, _Subtitle, _Description ,_Author ):
     ...
     top.write("""<!doctype html><html lang="en"><head>     <meta charset="utf-8">     <meta name="viewport" content="width=device-width, initial-scale=1">     <meta name="description" content="">     <meta name="author" content="Mark Otto, Jacob Thornton, and Bootstrap contributors">     <meta name="generator" content="Hugo 0.108.0"><title>"""
     + _Title +
     ...
     + _Description + 
               """</p>               </div>          </div>
               <!-- * Newest post --> <div class="row g-5" id="newest">               <div class="col-md-8">                    <article class="blog-post">                         <h2 class="blog-post-title mb-1">blog-post-title</h2>                         <p class="blog-post-meta">January 1, 2021</p>
                 """)
     top.close()
     ...
     bottom.write("""
               </article>               </div>               <div class="col-md-4">                    <div class="position-sticky" style="top: 2rem;">                         <div class="p-4">                              <h4 class="fst-italic">Archives</h4>                              <ol class="list-unstyled mb-0">                                   
