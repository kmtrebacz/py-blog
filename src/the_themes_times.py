...
def main(_Title, _Subtitle, _Description ,_Author, _Pass):
     ...
     with open (os.path.join('./themes/ttt/nav.php')) as navThms:
     ...
     with open (os.path.join('./themes/ttt/top.php')) as topThms:
     ...
     with open (os.path.join('./themes/ttt/bottom.php')) as bottomThms:
     ...
     with open (os.path.join('./themes/ttt/index.php')) as indexThms:
